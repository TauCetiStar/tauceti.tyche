 ...
 */
public class PredictionReaderImpl extends AbstractDrawReader implements DrawReader {

	public PredictionReaderImpl() {
	}
	...
	public List<Draw> read(InputStream input, DrawFilter filter) throws IOException {
		...
		if (lines != null) {
			...
			for (String line : lines) {
				if (line.contains("Draw #") || line.contains("Draw Date") || line.contains("Number_") || line.startsWith("//") || line.startsWith("#")) {
					continue;
				}
