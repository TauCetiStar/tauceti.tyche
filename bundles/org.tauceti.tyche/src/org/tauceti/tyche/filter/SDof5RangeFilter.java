 ...
 */
public class SDof5RangeFilter extends DrawFilterImpl implements DrawFilter {

	protected float min = -1;
	protected float max = -1;

	public SDof5RangeFilter() {
	}
	 ...
	 * @param max
	 */
	public SDof5RangeFilter(float min, float max) {
		this.min = min;
		this.max = max;
	}
	...
	public boolean accept(Draw draw) {
		float SD = DrawUtil.getSDof5Numbers(draw);
	...
	public String toString() {
		return "Stand-Deviation-Of-5 [" + this.min + ", " + this.max + "]";
	}
}
