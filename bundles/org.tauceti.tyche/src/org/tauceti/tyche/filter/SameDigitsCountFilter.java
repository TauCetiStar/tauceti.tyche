 ...
 */
public class SameDigitsCountFilter extends DrawFilterImpl implements DrawFilter {

	protected int min = -1;
	protected int max = -1;

	public SameDigitsCountFilter() {
	}
	 ...
	 * @param max
	 */
	public SameDigitsCountFilter(int min, int max) {
		this.min = min;
		this.max = max;
	}
	...
	public String toString() {
		return "Same Digits Count [" + this.min + ", " + this.max + "]";
	}
}
