 ...
 */
public class ContinuousNumbersCountFilter extends DrawFilterImpl implements DrawFilter {

	protected int min = -1;
	protected int max = -1;

	public ContinuousNumbersCountFilter() {
	}
	 ...
	 * @param max
	 */
	public ContinuousNumbersCountFilter(int min, int max) {
		this.min = min;
		this.max = max;
	}
	...
	public String toString() {
		return "Continuous Numbers Count [" + this.min + ", " + this.max + "]";
	}
}
